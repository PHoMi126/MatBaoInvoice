...
{
    public class PublishInvoiceParameters
    {
        ...
        public string MaKH { get; set; } //Mã số KH
        ...
        public List<PublishInvoiceProducts> Products { get; set; }
    }

    public class PublishInvoiceProducts
    {
